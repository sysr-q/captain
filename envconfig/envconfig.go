...
// Strings is a naive comma separated list of strings. It is naive in that it
// doesn't handle "escaped" commas well, nor acknowledge quotation marks to
// escape commas. This is very much a domain specific feature, rather than a
